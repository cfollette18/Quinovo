...
def adk_function_tools() -> str:
    lines = [
        ...
        "    def about(name: str, limit: int = 20):",
        "        return kernel.about(name, limit=limit)",
        "    def recall(query: str, topic: str | None = None, limit: int = 20):",
        "        return kernel.recall(query, topic=topic, limit=limit)",

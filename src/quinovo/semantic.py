...
def _prompt(text: str, topic: str, known: list[str], include_work: bool) -> str:
    ...
    return (
        ...
        "- An entity name is the short proper name someone would say out loud "
        "(Langfuse, Epicor, heater, Clee): one to three words, no versions, paths, "
        "possessives, or descriptions. 'Aider 0.86.2 on hearth' is entity 'Aider' "
        "with facts version=0.86.2 and runs_on=hearth. 'the user's laptop' is not "
        "an entity unless the laptop has a name.\n"
